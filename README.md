...
The portal can be used for all the (languages supported by 
Kendra Translate)[https://docs.aws.amazon.com/translate/latest/dg/what-is-languages.html#what-is-languages-supported]
